...
object DataLoader {
  ...
  // 定义常量
  val MOVIE_DATA_PATH = "D:\\classhome\\project\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\movies.csv"
  val RATING_DATA_PATH = "D:\\classhome\\project\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\ratings.csv"
  val TAG_DATA_PATH = "D:\\classhome\\project\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\tags.csv"
  ...
  def main(args: Array[String]): Unit = {
    ...
    val config = Map(
      "spark.cores" -> "local[*]",
      "mongo.uri" -> "mongodb://nn1.hadoop:27017/recommender",
      "mongo.db" -> "recommender",
      "es.httpHosts" -> "nn1.hadoop:9200",
      "es.transportHosts" -> "nn1.hadoop:9300",
